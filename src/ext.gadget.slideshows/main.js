// <nowiki>
( ( mw ) => mw.loader.using( [ 'ext.gadget.logger', 'ext.gadget.polyfills-weakref' ], ( require ) => {
...
const css = {
	...
	slideCountVar: '--boir-slide-count',
...
const enable = ( slideshow ) => {
	...
	slideshow.style.setProperty( css.slideCountVar, titles.length );
